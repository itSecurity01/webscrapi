      ...
      <div class="panel">
        ...
        <form method="post" action="/batch/build" id="sheet-form">
          ...
          <div>
            ...
            <button type="submit" formaction="/batch/discard" class="secondary" formnovalidate>Upload a different file instead</button>
          </div>
        </form>
      </div>`;
}
...
function pendingUploadPanel(pendingUpload, pendingSource) {
    ...
    return `
      ...
      <div class="panel" style="display:flex; gap:10px; flex-wrap:wrap; align-items:center;">
        ...
        ${repickHtml}
        <form method="post" action="/batch/discard" style="display:inline;"><button type="submit" class="secondary">Upload a different file instead</button></form>
      </div>`;
}
